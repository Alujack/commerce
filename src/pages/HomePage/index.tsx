...
export default function HomePagePage() {
  ...
  return (
    <>
      ...
      <div className="flex flex-col w-full gap-[22px] bg-gray-300_12">
        <div className="flex flex-col w-full gap-[27px] mx-auto md:p-5 max-w-[1330px]">
          <header className="flex md:flex-col justify-between items-center pr-12 gap-5 md:pr-5 border border-solid deep_purple_700_pink_400_01_border bg-white-A700">
                ...
                <Input
                  ...
                  suffix={
                    searchBarValue16?.length > 0 ? (
                      <CloseSVG onClick={() => setSearchBarValue16("")} height={24} width={24} fillColor="#b0b9beff" />
                    ) : (
            ...
            <div className="flex flex-col gap-[15px]">
              <div className="flex md:flex-col items-center gap-9">
                  ...
                  <div className="rounded-[10px]">
                    <div className="flex flex-col items-start h-[310px] md:h-auto gap-[45px] p-8 sm:p-5 bg-[url(/public/images/defaultNoData.png)] bg-cover bg-no-repeat rounded-[10px]">
                      <div className="flex flex-col items-start w-[44%] md:w-full ml-[7px] md:ml-0">
                        ...
                        <Text size="s" as="p" className="mt-1 !text-white-A700 capitalize">
                          Wifi, Voice Assistant,
                        </Text>
                        <Text size="s" as="p" className="mt-1.5 !text-white-A700 capitalize">
                  ...
                  <div className="flex md:flex-col gap-[19px]">
                    <div className="flex flex-col items-start justify-center h-[120px] w-full md:h-auto gap-9 p-[15px] bg-[url(/public/images/defaultNoData.png)] bg-cover bg-no-repeat">
                      <Text
                        size="xl"
                        as="p"
                        className="w-[37%] md:w-full mt-1 ml-1 md:ml-0 !font-medium leading-[18px]"
                      >
                ...
                <div className="flex flex-col md:self-stretch gap-[17px] flex-1">
                  <div className="rounded-[10px]">
                    <div className="flex flex-col items-start justify-center h-[215px] md:h-auto p-[23px] sm:p-5 bg-[url(/public/images/defaultNoData.png)] bg-cover bg-no-repeat rounded-[10px]">
                      <Heading
                        size="6xl"
                        as="h5"
                        className="w-[43%] md:w-full !text-white-A700 uppercase leading-[27px]"
                      >
                        <span className="text-white-A700">
                          <>
                            OKODo
                  ...
                  <div className="rounded-[10px]">
                    <div className="flex flex-col items-end h-[215px] md:h-auto p-[17px] bg-[url(/public/images/defaultNoData.png)] bg-cover bg-no-repeat rounded-[10px]">
                      <Text size="xs" as="p" className="mt-[9px] mr-[78px] md:mr-0 uppercase">
                        xomia
                      </Text>
                      ...
                      <Button className="h-[32px] mt-[30px] mb-[18px] mr-[17px] px-[15px] md:mr-0 text-white-A700 uppercase text-[11px] font-medium bg-blue_gray-900 min-w-[92px] rounded-[10px]">
                        Shop Now
                      </Button>
                    </div>
                  </div>
                ...
                <div className="flex flex-col items-center w-full gap-[38px] p-[21px] sm:p-5 bg-white-A700 rounded-[10px]">
                  ...
                  <div className="flex sm:flex-col items-start w-[88%] md:w-full">
                    <Img
                      ...
                      alt="Link   logo4 png"
                      className="w-[24%] sm:w-full object-cover"
                    />
                    <Img
                      src="images/defaultNoData.png"
                      alt="Link   logo5 png"
                ...
                <div className="flex flex-col items-center w-full gap-8 p-[15px] bg-white-A700 rounded-[10px]">
                  <div className="flex self-stretch justify-between items-start mt-[13px] gap-5">
                    <div className="flex pb-2 px-2">
                      <Heading size="2xl" as="h6" className="ml-[7px] md:ml-0 uppercase">
                        top categories
                      </Heading>
                    </div>
              ...
              <div className="flex flex-col gap-[15px]">
                <div className="flex sm:flex-col justify-between items-center gap-5 px-[21px] sm:px-5 bg-green-700 rounded-[10px]">
                  <div className="flex p-2.5">
                    <Heading size="4xl" as="h5" className="mt-3 mb-2 !text-white-A700 uppercase !font-semibold">
                      Explore Our Product’s New Arrival
                    </Heading>
                  </div>
                  <Button className="h-[31px] mr-6 px-2.5 md:mr-0 sm:p-5 text-gray-800_01 capitalize text-lg font-medium bg-gray-200_02 min-w-[89px] rounded-[10px]">
                    View All{" "}
                  </Button>
                </div>
                <div className="justify-center gap-5 grid-cols-[repeat(auto-fill,_minmax(226px_,_1fr))] bg-white-A700 grid rounded-[10px]">
                  <div className="flex flex-col items-center justify-center w-full gap-6 p-3 bg-gray-100_04 rounded-[10px]">
                    <div className="flex flex-col self-stretch mt-1 gap-2">
              ...
              <div className="flex flex-col gap-3.5">
                <div className="flex justify-between items-center gap-5 p-3.5 bg-green-700 rounded-[10px]">
                  <Heading
                    size="4xl"
                    as="h5"
                    className="self-end mb-[5px] ml-[15px] md:ml-0 !text-white-A700 uppercase !font-semibold"
                  >
                    Explore Our Product’s Best seller
                  </Heading>
                  <Button className="h-[31px] mr-[30px] px-2.5 md:mr-0 text-gray-800_01 capitalize text-lg font-medium bg-gray-200_02 min-w-[89px] rounded-[10px]">
                    View All{" "}
                  </Button>
                </div>
                <div className="flex flex-col pb-[38px] gap-[15px] sm:pb-5 bg-white-A700 rounded-[10px]">
                  <div className="flex md:flex-col justify-between items-center gap-5">
                    <div className="flex flex-col items-start h-[190px] w-[46%] md:w-full md:h-auto ml-[13px] gap-2 p-[18px] md:ml-0 bg-[url(/public/images/defaultNoData.png)] bg-cover bg-no-repeat rounded-[28px]">
                    ...
                    <div className="w-[50%] md:w-full mr-[34px] md:mr-0">
                      <div className="justify-center gap-[76px] grid-cols-[repeat(auto-fill,_minmax(164px_,_1fr))] my-4 grid">
              ...
              <div className="bg-white-A700">
                <div className="flex md:flex-col gap-[19px] z-[1]">
                  <div className="flex flex-col items-center md:self-stretch gap-[42px] flex-1">
                    <div className="flex self-stretch justify-between items-start gap-5 p-[7px] bg-green-700 rounded-[10px]">
                      ...
                      <Button className="h-[31px] mb-[17px] mr-6 px-2.5 md:mr-0 text-gray-800_01 capitalize text-lg font-medium bg-gray-200_02 min-w-[89px] rounded-[10px]">
                        View All{" "}
                      </Button>
                    </div>
                    <div className="flex w-[95%] md:w-full mb-4 py-[21px] sm:py-5">
                      <div className="flex flex-col items-start w-[50%] md:w-full mb-3.5">
                        <div className="flex flex-col items-start justify-center mt-9 ml-[52px] p-[5px] md:ml-0 bg-green-700 rounded-[10px]">
                        ...
                        <Img src="images/defaultNoData.png" alt="prod5 png" className="self-end w-[93%] object-cover" />
                      </div>
                    </div>
                  </div>
                  <div className="flex flex-col w-[23%] md:w-full gap-2 bg-white-A700">
                    ...
                    <Img
                      src="images/defaultNoData.png"
                      alt="Main   Section  "
                      className="h-[174px] object-cover rounded-[12px]"
                    />
                  </div>
                </div>
                <div className="flex md:flex-col mb-[7px] gap-5">
                  <div className="flex flex-col w-full pt-4 gap-3 px-4 bg-gray-100_04 rounded-[10px]">
                    <Img src="images/defaultNoData.png" alt="Image" className="object-cover rounded" />
                    <div className="flex flex-col items-start pb-3 gap-[13px]">
                      <div className="flex flex-col items-start">
              ...
              <div className="flex md:flex-col items-start h-[107px] md:h-auto p-9 sm:p-5 bg-[url(/public/images/defaultNoData.png)] bg-cover bg-no-repeat flex-wrap rounded-[15px]">
                <Img
                  src="images/defaultNoData.png"
                  alt="Heading 6   star png"
                  className="w-[30px] md:w-full mb-1 ml-[232px] md:ml-0 object-cover"
                />
                <Text size="3xl" as="p" className="ml-2.5 md:ml-0 !text-white-A700 text-center">
                  Member get
                </Text>
                <Text size="3xl" as="p" className="mt-[7px] ml-[11px] md:ml-0 !text-yellow-A400 uppercase text-center">
                  FREE SHIPPING*
                </Text>
                <Text size="3xl" as="p" className="mt-[5px] ml-1 md:ml-0 !text-white-A700 text-center">
                  with no order minimum!. *Restriction apply
                </Text>
              </div>
              <div className="flex flex-col gap-[18px] bg-white-A700">
                <div className="flex md:flex-col justify-between items-center gap-5 px-5 bg-green-700 rounded-[10px]">
                  <div className="flex p-2.5">
                    <Heading
                      size="4xl"
                      as="h5"
                      className="mt-[11px] mb-[9px] !text-white-A700 uppercase !font-semibold"
                    >
                      Explore Our Product’s checking all product
                    </Heading>
                  </div>
                  <Button className="h-[31px] mr-[25px] px-2.5 md:p-5 md:mr-0 text-gray-800_01 capitalize text-lg font-medium bg-gray-200_02 min-w-[89px] rounded-[10px]">
                    View All{" "}
                  </Button>
                </div>
                    ...
                    <div className="flex flex-col gap-[30px]">
                      ...
                      <div className="flex items-start h-[190px] md:h-auto p-[30px] sm:p-5 bg-[url(/public/images/defaultNoData.png)] bg-cover bg-no-repeat rounded-[10px]">
                        <Heading
                          size="md"
                          as="p"
                          className="w-[18%] mt-[3px] mb-[59px] !text-white-A700 leading-[22px]"
                        >
                          <>
                            Best
                            <br />
                ...
                <div className="flex md:flex-col mb-[3px] gap-[18px]">
                  <div className="flex flex-col w-full pt-4 gap-3 px-4 bg-gray-100_04 rounded-[10px]">
                    <Img src="images/defaultNoData.png" alt="Image" className="object-cover rounded" />
                    <div className="flex flex-col items-start pb-3.5 gap-[13px]">
                      <div className="flex flex-col items-start">
                        <Text as="p" className="!text-blue_gray-500 !font-manrope">
                          Extra Bass
                        </Text>
              ...
              <div className="flex md:flex-col gap-9">
                <div className="flex w-full">
                  <div className="flex flex-col items-end justify-center h-[180px] w-full md:h-auto gap-[7px] p-10 sm:p-5 bg-[url(/public/images/defaultNoData.png)] bg-cover bg-no-repeat">
                    <Heading size="14xl" as="h1" className="mr-[30px] md:mr-0 !text-yellow-A400">
                      10% Back
                    </Heading>
        ...
        <footer className="p-[35px] sm:p-5 bg-white-A700 rounded-[5px]">
          <div className="w-full mx-auto my-9 max-w-[1370px]">
            <div className="pb-2.5 px-2.5 bg-gray-100_04 rounded-[20px]">
              <div className="flex flex-col items-center justify-center gap-[15px]">
                ...
                <div className="flex flex-col self-stretch items-center gap-[25px]">
                  <Img
                    src="images/defaultNoData.png"
                    alt="Frame 947"
                    className="h-[20px] w-full md:h-auto object-cover"
                  />
                  <div className="flex md:flex-col justify-between items-start w-[92%] md:w-full gap-5">
