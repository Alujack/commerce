  ...
  return (
    <>
      ...
      <div className="flex flex-col w-full pt-5 gap-3.5 bg-white-A700">
            ...
            <div className="flex flex-col w-[76%] md:w-full gap-2">
              <div className="flex md:flex-col gap-[47px]">
                <Input
                  ...
                  onChange={(e: string) => setSearchBarValue68(e)}
                  suffix={
                    searchBarValue68?.length > 0 ? (
                      <CloseSVG onClick={() => setSearchBarValue68("")} height={24} width={24} fillColor="#b0b9beff" />
                    ) : (
          ...
          <div>
            ...
            <div className="h-[961px] mt-[-11px] relative">
              <div className="flex flex-col items-start w-full gap-[61px] bottom-[0.00px] right-0 left-0 m-auto sm:gap-[30px] absolute">
                <div className="flex md:flex-col items-start w-[74%] md:w-full ml-[35px] gap-[30px] md:ml-0">
                  <div className="flex sm:flex-col items-start md:self-stretch mt-[21px] flex-1">
                  ...
                  <div className="flex flex-col items-start justify-center w-[48%] md:w-full p-[7px]">
                    <Heading as="h6" className="w-[80%] md:w-full mt-1 !font-bold leading-[19px]">
                      <>
                    ...
                    <div className="flex items-center w-[82%] md:w-full mt-[18px] gap-[11px]">
                      <div className="h-[6px] w-[6px] bg-gray-700_03 rounded-[3px]" />
                      <Text size="s" as="p">
                        Intel LGA 1700 Socket: Supports 13th & 12th Gen Intel Core
                      </Text>
                    </div>
                    <div className="flex items-center w-[78%] md:w-full mt-[5px] gap-[11px]">
                      <div className="h-[6px] w-[6px] bg-gray-700_03 rounded-[3px]" />
                      <Text size="s" as="p">
                        DDR5 Compatible: 4*SMD DIMMs with XMP 3.0 Memory
                      </Text>
                    </div>
                    <div className="flex items-center w-[85%] md:w-full mt-[5px] gap-[11px]">
                      <div className="h-[6px] w-[6px] bg-gray-700_03 rounded-[3px]" />
                      <Text size="s" as="p">
                    ...
                    <div className="flex flex-col self-stretch items-start mt-5 mb-2 gap-[13px] py-1 border-gray-300_10 border-t border-solid">
        ...
        <footer className="py-[71px] md:py-5 bg-white-A700">
          <div className="pb-2.5 bg-gray-100_04 rounded-[10px]">
            <div className="flex flex-col gap-[15px]">
              <div className="flex md:flex-col justify-between items-center w-full pr-2.5 gap-5 mx-auto md:p-5 max-w-[1260px]">
              ...
              <div className="flex flex-col gap-[25px]">
                ...
                <div className="flex md:flex-col justify-between items-start w-full gap-5 mx-auto md:p-5 max-w-[1238px]">
