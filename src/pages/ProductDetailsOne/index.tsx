...
export default function ProductDetailsOnePage() {
            ...
            <div className="flex md:flex-col justify-between items-center w-[97%] md:w-full mt-2 gap-5">
              ...
              <div className="flex md:flex-col justify-between items-start w-[76%] md:w-full gap-5">
                <Input
                  ...
                  onChange={(e: string) => setSearchBarValue69(e)}
                  suffix={
                    searchBarValue69?.length > 0 ? (
                      <CloseSVG onClick={() => setSearchBarValue69("")} height={24} width={24} fillColor="#b0b9beff" />
                    ) : (
