...
export default function Footer1({ ...props }: Props) {
  return (
    <footer {...props}>
      <div className="flex flex-col items-center justify-center w-full gap-[45px] py-[7px] mx-auto my-[15px] md:p-5 bg-gray-100_04 max-w-[1329px] rounded-[10px]">
        ...
        <div className="flex md:flex-col items-start w-[94%] md:w-full mb-[5px]">
          ...
          <div className="flex flex-col items-start w-[22%] md:w-full mt-[34px] ml-[129px] gap-[19px] md:ml-0">
